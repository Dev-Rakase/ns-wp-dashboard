    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage all WordPress installations</p>
        </div>
        <Link
          href="/websites/new"
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {websites.map((website) => (
                <tr key={website.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getPlanColor(website.plan)}`}>
                      {website.plan}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">
                      {formatCredits(website.creditsRemaining)} / {formatCredits(website.creditsTotal)}
                    </div>
                      ...
                      <div
                        className={`h-1.5 rounded-full ${
                          website.creditsRemaining < website.creditsTotal * 0.2
                            ? "bg-red-600"
                            : website.creditsRemaining < website.creditsTotal * 0.5
                            ? "bg-yellow-600"
                            : "bg-green-600"
                        }`}
                        style={{
                          width: `${(website.creditsRemaining / website.creditsTotal) * 100}%`,
                        }}
                      />
                    </div>
                  </td>
